...
qm_conf_ofs.promote_parameter('data_out', promoted_name='qm_conf_ofs',
                      description='Post-QM Conformers output',
                      default='qm_confs',
                      title='Post-QM Conformers')


# Connect ports
ifs.success.connect(fraggenCube.intake)
ifs.success.connect(assembler.init)
...
psi4EnergyCube2.success.connect(assembler.intake)
psi4EnergyCube2.failure.connect(failfs2.intake)
psi4EnergyCube2.system_failure.connect(failfs3.intake)

assembler.success.connect(ofs.intake)
assembler.qm_conf_output.connect(qm_conf_ofs.intake)
